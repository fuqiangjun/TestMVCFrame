...
//                tween = transform.DORotate(endValueV3, duration, optionalRotationMode);
            ...
            case DOTweenAnimationType.Color:
                ...
                else if (t.IsSameOrSubclassOf(typeof(TextT))) tween = ((TextT)target).DOColor(endValueColor, duration);
#if DOTWEEN_TK2D
...
//                }
            ...
            case DOTweenAnimationType.Fade:
                ...
                else if (t.IsSameOrSubclassOf(typeof(TextT))) tween = ((TextT)target).DOFade(endValueFloat, duration);
#if DOTWEEN_TK2D
...
//                }
            ...
            case DOTweenAnimationType.Text:
                if (t.IsSameOrSubclassOf(typeof(TextT))) tween = ((TextT)target).DOText(endValueString, duration, optionalBool0, optionalScrambleMode, optionalString);
//                c = this.GetComponent<Text>();
//                if (c != null) {
